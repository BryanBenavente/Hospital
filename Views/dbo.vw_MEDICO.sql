...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_MEDICO]
AS
SELECT        MEDICO.ESPECIALIDAD.NOMESP, MEDICO.MEDICO_ESPECIALIDAD.DESCESP, MEDICO.MEDICO.APEPATMED
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_MEDICO', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_MEDICO', NULL, NULL
GO
